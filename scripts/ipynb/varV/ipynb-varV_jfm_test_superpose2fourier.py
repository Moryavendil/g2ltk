...
# norm_z = Normalize(vmax=zpwmax, vmin=0, clip=True)
...
fig, axes = plt.subplots(1, 1, squeeze=False, sharex=True, sharey=True, figsize=utility.figsize('double', ratio=1))
...
im_zpw = ax.imshow(Z_pw, norm=norm_z, **imshow_kw)
