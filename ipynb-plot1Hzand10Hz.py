...
cmap_Na = LinearSegmentedColormap.from_list("mycmap", ['black', "xkcd:bright yellow"])
...
bigdata[acquisition] = {'data': {**data}, 'probecolors': probecolors, 'interesting_probes': interesting_probes}
...
for acqu in bigdata.keys():
    data = bigdata[acqu]['data']
    probecolors = bigdata[acqu]['probecolors']
    interesting_probes = bigdata[acqu]['interesting_probes']
